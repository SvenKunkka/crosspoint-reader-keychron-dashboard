...
#include "activities/dashboard/ShowcaseRenderer.h"
...
void SleepActivity::onEnter() {
  ...
  return renderShowcaseSleepScreen();
...
void SleepActivity::renderShowcaseSleepScreen() const {
  ShowcaseRenderer::renderSleep(renderer);
  renderer.displayBuffer(HalDisplay::FULL_REFRESH);
}
